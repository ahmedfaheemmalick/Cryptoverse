...
const SideBar = () => {
    return (
        <div className="min-h-screen h-full w-64 overflow-y-auto py-4 px-3 bg-gray-50 dark:bg-gray-800">
            <ul className="space-y-2">
                ...
                <li>
                    <Link to="/coins" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
